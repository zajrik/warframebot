...
class Bot extends Client
{
	...
	constructor(name, token)
	{
		...
		// Register commands
		this.commands.Register(new Command_Alerts());
		this.commands.Register(new Command_Invasions());
		this.commands.Register(new Command_Sub());
		this.commands.Register(new Command_Unsub());
		this.commands.Register(new Command_List());
		this.commands.Register(new Command_Wiki());
		this.commands.Register(new Command_Sellers());
		this.commands.Register(new Command_Buyers());
		this.commands.Register(new Command_PriceCheck());
		this.commands.Register(new Command_Dice());
		this.commands.Register(new Command_Help());
		this.commands.Register(new Command_Invite());
		...
		// Schedule tasks
		this.scheduler.Schedule(new Task_RewardNotifier(5 * 60));
